...
export default function UpdateReportedClass() {
    ...
    const [reportsBefore, setReportsBefore] = useState<ClassReport[]>([]);
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
            ...
            <View style={styles.component}>
                ...
                <IconReport
                    ...
                    credibility={classReport?.user?.information?.point ?? 0}
                />
                ...
                <IconReport
                    ...
                    credibility={classReport?.class?.author?.information?.point ?? 0}
                />
            ...
            <View style={styles.component1}>
                {reportsBefore.length > 0 &&
                reportsBefore[0]?.content !== null ? (
                    <>
                        <Text style={styles.smallTitle3}>
                            Đã bị báo cáo {reportsBefore.length} lần
                        </Text>
                        <View style={styles.reportParent}>
                            ...
                            >
                                {reportsBefore.map((report, index) => (
                                                ...
                                                AUser.minusUserPoints(
                                                    ...
                                                    (pointResponse) => {
                                                        if (pointResponse.success) {
                                                            ...
                                                            AClass.lockClass(
                                                                classReport?.class?.id ?? -1, // ID lớp học
                                                                (lockResponse) => {
                                        ...
                                        },
                                        {
                                            ...
                                            onPress: () => {
                                                ...
                                                AClassReport.denyClassReport(
                                                    classReport?.id ?? -1, // Thay `classReport?.reportId` với ID báo cáo lớp học
                                                    (response) => {
                                                        if (response.success) {
                                                    ...
                                                    (loading) => {
                                                    } // Có thể xử lý trạng thái loading nếu cần thiết
                                                );
                                            },
                                        },
                                    ]
