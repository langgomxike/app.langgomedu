  ...
  return (
    <ScrollView >
      ...
      <InputRegister
            ...
            required={true}
            onChangeText={handleInputChangePassword} // Hàm cập nhật state khi nhập
      ...
      <Button title="Đăng nhập" textColor="white" backgroundColor="blue" onPress={handleLogin}></Button>
